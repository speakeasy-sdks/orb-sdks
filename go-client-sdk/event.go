...
func (s *event) PutEventsDeprecateEventID(ctx context.Context, request operations.PutEventsDeprecateEventIDRequest) (*operations.PutEventsDeprecateEventIDResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.PutEventsDeprecateEventID200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}

			res.PutEventsDeprecateEventID200ApplicationJSONObject = out
		}
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.PutEventsDeprecateEventID400ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}

			res.PutEventsDeprecateEventID400ApplicationJSONObject = out
		}
	}

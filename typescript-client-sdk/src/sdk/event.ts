...
export class Event {
  ...
  **/
  postEventsSearch(
    req: operations.PostEventsSearchRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostEventsSearchResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostEventsSearchRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.PostEventsSearchResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postIngest(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostIngestResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  putEventsDeprecateEventId(
    req: operations.PutEventsDeprecateEventIdRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PutEventsDeprecateEventIdResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutEventsDeprecateEventIdRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/events/{event_id}/deprecate", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutEventsDeprecateEventIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  putEventsEventId(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/events/{event_id}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutEventsEventIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {

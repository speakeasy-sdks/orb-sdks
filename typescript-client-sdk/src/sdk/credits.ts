...
export class Credits {
  ...
  **/
  getCustomersCustomerIdCredits(
    req: operations.GetCustomersCustomerIdCreditsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetCustomersCustomerIdCreditsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetCustomersCustomerIdCreditsRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/customers/{customer_id}/credits", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetCustomersCustomerIdCreditsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getCustomersCustomerIdCreditsLedger(
    req: operations.GetCustomersCustomerIdCreditsLedgerRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetCustomersCustomerIdCreditsLedgerResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetCustomersCustomerIdCreditsLedgerRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/customers/{customer_id}/credits/ledger", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetCustomersCustomerIdCreditsLedgerResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
   ...
   * ```
  **/
  postCustomersCustomerIdCreditsLedgerEntry(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostCustomersCustomerIdCreditsLedgerEntryRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/customers/{customer_id}/credits/ledger_entry", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostCustomersCustomerIdCreditsLedgerEntryResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {

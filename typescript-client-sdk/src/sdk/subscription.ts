...
export class Subscription {
  ...
  **/
  getSubscriptionsCostsById(
    req: operations.GetSubscriptionsCostsByIdRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetSubscriptionsCostsByIdResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetSubscriptionsCostsByIdRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/costs", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetSubscriptionsCostsByIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getSubscriptionsSubscriptionId(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}", req.pathParams);
  ...
  **/
  getSubscriptionsSubscriptionIdSchedule(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetSubscriptionsSubscriptionIdScheduleRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/schedule", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetSubscriptionsSubscriptionIdScheduleResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  getSubscriptionsSubscriptionIdUsage(
    req: operations.GetSubscriptionsSubscriptionIdUsageRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetSubscriptionsSubscriptionIdUsageResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetSubscriptionsSubscriptionIdUsageRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/usage", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetSubscriptionsSubscriptionIdUsageResponse = {statusCode: httpRes.status, contentType: contentType};
        }
  ...
  **/
  postSubscriptions(
    req: operations.PostSubscriptionsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostSubscriptionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostSubscriptionsRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostSubscriptionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscription = httpRes?.data;
  ...
  **/
  postSubscriptionsSubscriptionIdCancel(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostSubscriptionsSubscriptionIdCancelRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/cancel", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostSubscriptionsSubscriptionIdCancelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscription = httpRes?.data;
  ...
  **/
  postSubscriptionsSubscriptionIdSchedulePlanChange(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostSubscriptionsSubscriptionIdSchedulePlanChangeRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/schedule_plan_change", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostSubscriptionsSubscriptionIdSchedulePlanChangeResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscription = httpRes?.data;
  ...
  **/
  postSubscriptionsSubscriptionIdUnschedulePendingCancellation(
    req: operations.PostSubscriptionsSubscriptionIdUnschedulePendingCancellationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostSubscriptionsSubscriptionIdUnschedulePendingCancellationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostSubscriptionsSubscriptionIdUnschedulePendingCancellationRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/unschedule_cancellation", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostSubscriptionsSubscriptionIdUnschedulePendingCancellationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscription = httpRes?.data;
  ...
  **/
  postSubscriptionsSubscriptionIdUnschedulePendingPlanChanges(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/unschedule_pending_plan_changes", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostSubscriptionsSubscriptionIdUnschedulePendingPlanChangesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscription = httpRes?.data;
  ...
  **/
  postSubscriptionsSubscriptionIdUpdateFixedFeeQuantity(
    req: operations.PostSubscriptionsSubscriptionIdUpdateFixedFeeQuantityRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostSubscriptionsSubscriptionIdUpdateFixedFeeQuantityResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostSubscriptionsSubscriptionIdUpdateFixedFeeQuantityRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/subscriptions/{subscription_id}/update_fixed_fee_quantity", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostSubscriptionsSubscriptionIdUpdateFixedFeeQuantityResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.subscription = httpRes?.data;
